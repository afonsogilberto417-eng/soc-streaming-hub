    ...
    <section className="py-24 px-4 bg-gradient-section">
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <motion.a
            href="https://wa.me/558596483469?text=Ol%C3%A1%2C%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20a%20SocialFlix!"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center gap-3 px-8 py-4 rounded-lg bg-[#25D366] font-display font-bold text-lg text-white hover:bg-[#20bd5a] transition-all duration-300 shadow-lg"
          >
