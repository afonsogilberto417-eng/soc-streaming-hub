...
const conversations: Conversation[] = [
  {
    ...
    avatar: avatarCarlos,
    messages: [
      { from: "client", text: "Oi! Vi o anúncio, roda bem no Android?", time: "19:42" },
      { from: "atendimento", text: "Oi! Sim, otimizado pra Android 😊", time: "19:44" },
      { from: "client", text: "Testei e rodou liso! Full HD sem travar.", time: "20:15" },
      { from: "atendimento", text: "Que ótimo! Obrigado pela confiança 🙌", time: "20:16" },
    ],
  },
  {
    name: "+55 21 9●●●●-●●15",
    avatar: avatarLucas,
    messages: [
      { from: "client", text: "O de vocês aguenta futebol ao vivo?", time: "21:10" },
      { from: "atendimento", text: "Sim! Servidores preparados pra ao vivo ⚽", time: "21:12" },
      { from: "client", text: "Testei ontem, não travou! Qualidade top.", time: "22:30" },
  ...
  },
  {
    ...
    messages: [
      { from: "client", text: "Vim agradecer! Teste de 7 dias ótimo.", time: "14:20" },
      { from: "atendimento", text: "Que bom! O que mais gostou? 😊", time: "14:21" },
      { from: "client", text: "Canais e filmes atualizados. Parabéns!", time: "14:22" },
      { from: "atendimento", text: "Obrigado pelo retorno! 💚", time: "14:23" },
    ],
  },
  {
    name: "+55 41 9●●●●-●●36",
    avatar: avatarRafael,
    messages: [
      { from: "client", text: "App leve e rápido! Aceita cartão?", time: "10:45" },
      { from: "atendimento", text: "Aceitamos Pix, cartão e boleto! 😊", time: "10:46" },
      { from: "client", text: "Perfeito! Manda o Pix!", time: "10:47" },
      { from: "atendimento", text: "Enviando agora! 🎉", time: "10:48" },
    ],
  },
  {
    name: "+55 85 9●●●●-●●91",
    ...
    messages: [
      { from: "client", text: "Minha internet é de 50 mega, funciona?", time: "16:28" },
      { from: "atendimento", text: "Funciona sim! Sistema otimizado 😉", time: "16:29" },
      { from: "client", text: "Testei e ficou estável mesmo! Top.", time: "16:30" },
      { from: "atendimento", text: "Muito obrigado pelo feedback! 🙌", time: "16:31" },
    ],
  },
  {
    name: "+55 71 9●●●●-●●54",
    ...
    messages: [
      { from: "client", text: "Foi super fácil de instalar!", time: "11:05" },
      { from: "atendimento", text: "Que bom! Precisou de ajuda? 😊", time: "11:06" },
      { from: "client", text: "Não! Qualidade HD top! Filhos adoraram 🎬", time: "11:07" },
      { from: "atendimento", text: "Família toda curtindo, que ótimo! 💚", time: "11:08" },
    ],
  },
  {
    name: "+55 48 9●●●●-●●27",
    avatar: avatarBruno,
    messages: [
      { from: "client", text: "Ativação imediata! Elogiar o suporte.", time: "09:15" },
      { from: "atendimento", text: "Bom dia! O que achou? 😊", time: "09:16" },
      { from: "client", text: "Nota 10! Já tô maratonando kkk 😅", time: "09:17" },
      { from: "atendimento", text: "Bom maratona! Estamos aqui 🍿", time: "09:18" },
    ],
  },
  {
    name: "+55 62 9●●●●-●●83",
    avatar: avatarCamila,
    messages: [
      { from: "client", text: "Testei as 4h grátis, gostei bastante!", time: "15:40" },
      { from: "atendimento", text: "Que bom! Funcionou tudo? 😊", time: "15:41" },
      { from: "client", text: "Sim! Quero fechar o plano anual 💪", time: "15:42" },
      { from: "atendimento", text: "Vou enviar os detalhes agora! 🎉", time: "15:43" },
    ],
  },
  {
    name: "+55 27 9●●●●-●●60",
    avatar: avatarDiego,
    messages: [
      { from: "client", text: "Qualidade 4K me surpreendeu! Olha 👇", time: "20:00" },
      { from: "client", text: "", time: "20:01", image: tvCliente },
      { from: "atendimento", text: "Ficou perfeita na TV! 🔥📺", time: "20:02" },
      { from: "client", text: "Interface organizada. Muito satisfeito!", time: "20:03" },
    ],
  },
  {
    name: "+55 51 9●●●●-●●45",
    avatar: avatarAndre,
    messages: [
      { from: "client", text: "Já usei outros, sempre dava problema.", time: "18:25" },
      { from: "atendimento", text: "Priorizamos estabilidade acima de tudo!", time: "18:26" },
      { from: "client", text: "Deu pra notar! Diferença absurda 👏", time: "18:27" },
      { from: "atendimento", text: "Obrigado pela confiança! 🙌", time: "18:28" },
    ],
  },
  {
    name: "+55 92 9●●●●-●●18",
    ...
    messages: [
      { from: "client", text: "Bastante variedade de filmes e séries!", time: "13:10" },
      { from: "atendimento", text: "Atualizamos o catálogo toda semana 🎬", time: "13:11" },
      { from: "client", text: "Minha mãe de 65 anos usa sozinha 😄", time: "13:12" },
      { from: "atendimento", text: "Fácil pra toda a família! 💚", time: "13:13" },
    ],
  },
  {
    name: "+55 19 9●●●●-●●37",
    ...
    messages: [
      { from: "client", text: "Testei em horário de pico, e aguentou!", time: "21:50" },
      { from: "atendimento", text: "E aí, o que achou? 😊", time: "21:51" },
      { from: "client", text: "Jogo inteiro sem travar. Nota 10! ⚽", time: "21:52" },
      { from: "atendimento", text: "Servidores preparados pra isso! 🏆", time: "21:53" },
    ],
  },
  {
    name: "+55 61 9●●●●-●●02",
    ...
    messages: [
      { from: "client", text: "Futebol ao vivo sem delay! Perfeito.", time: "17:35" },
      { from: "atendimento", text: "Boa tarde! Que bom ouvir isso! 😊", time: "17:36" },
      { from: "client", text: "Marido cancelou a outra assinatura 😂", time: "17:37" },
      { from: "atendimento", text: "Bem-vindos à família SocialFlix! 🎉", time: "17:38" },
    ],
  },
  {
    name: "+55 81 9●●●●-●●69",
    avatar: avatarThiago,
    messages: [
      { from: "client", text: "Carregamento rápido! Abre na hora.", time: "12:20" },
      { from: "atendimento", text: "Trabalhamos bastante nisso! 💪", time: "12:21" },
      { from: "client", text: "Imagem limpa, sem pixelado. Ótimo! 🤝", time: "12:22" },
      { from: "atendimento", text: "Obrigado pela confiança!", time: "12:23" },
    ],
  },
  {
    name: "+55 47 9●●●●-●●51",
    ...
    messages: [
      { from: "client", text: "App otimizado, sem travamento!", time: "19:00" },
      { from: "atendimento", text: "Testou em qual aparelho? 😊", time: "19:01" },
      { from: "client", text: "3 aparelhos, perfeito em todos! 🔥", time: "19:02" },
      { from: "atendimento", text: "Feedback assim nos motiva! 💚", time: "19:03" },
    ],
  },
];
